...
Page({
  ...
  onShow: function (params) {
    ...
    if (this.data.refreshAddress) {
      ...
      var address = {
        ...
        customer_mobile: receiverMobile
      }
  ...
  bindSelectCoupon: function () {
    var product_ids = this.data.cartItems.map(function (ele) {
      return ele.id
    })
    var products_order_quantities = this.data.cartItems.map(function (ele) {
      return ele.quantity
    })
    wx.navigateTo({
